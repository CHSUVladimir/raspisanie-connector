...
describe('Raspisanie', ()=>{
    ...
    test('Filetr Many', async()=>{
        try{
            ...
            await Raspisanie.Load(ds,de);
            Raspisanie.FilterByAuditory([1490345254033822000, 1488379776432345300,                   0,
                1488366378592244000, 1490349048817783000, 1671133117620949200,
                1490435777622970600, 1490346292951388400, 1490345254003413200,
                1490436480212930800, 1488372624649097500, 1671012457577976000,
                1490345254075765000, 1471774257598959900, 1490437243336135000,
                1490435838350201000, 1490350520895803600, 1490438777526555000]);
